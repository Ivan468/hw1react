      ...
      <div className="post">
        <div>
          <div className="name">
            ...
            <span className="twitter-linc"> @Test </span>{" "}
            <div className="more-blk">
              <svg viewBox="0 0 24 24" className="more">
                <g>
          ...
          {/* <p className="href">   <a href={link}>{link}</a> </p> */}
          <div className="img_block">
            <img srcSet={this.props.post.foto} alt={this.props.post.foto} />
          </div>
